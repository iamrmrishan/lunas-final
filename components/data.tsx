export const mails = [
  {
    ...
    subject:
      "Great for dry and sensetive skin, but unusual consistency may not be for everyone",
    text: "I have very dry sensitive skin and this is the only face cream that works. Been using it for several years. Hydration lasts all day.I did notice it is way cheaper to buy it on Amazon than in store (like Boots or similar if you're in the UK).The consistency is thicker than lotion but not heavy or greasy at all. However, when applying on the skin, rather than being fully absorbed it almost sets on top of the skin in a thin layer, almost like Vaseline. If you were to drag your fingernail across your face, you'd scrape some product off - and I wouldn't say it's because I apply too much. This consistency works for me as the layer almost acts as a protective barrier for my dry skin, but I know many people who don't enjoy it, so beware.",
    date: "2023-10-22T09:00:00",
    read: true,
    labels: ["review", "skincare", "health"],
  },
  {
    id: "110e8400-e29b-11d4-a716-446655440000",
    name: "Alice Smith",
    email: "alicesmith@example.com",
    subject: "is CeraVe cream good for dry skin ?",
    text: "caption",
    date: "2023-10-22T10:30:00",
    read: true,
    labels: ["question", "important", "skincare", "health"],
  },
  {
  ...
  },
  {
    ...
    subject:
      "is elite indian restaurant good for someone who can't handle spice ?",
